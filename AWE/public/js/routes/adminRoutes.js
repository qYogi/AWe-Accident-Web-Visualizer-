...
export async function handleAdminRoutes(req, res, pathname, cookies, searchParams) {
    const isLoggedIn = Boolean(cookies["admin_session"] && SESSIONS.has(cookies["admin_session"]));
